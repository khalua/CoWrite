            ...
            <div>
              <div className="flex gap-4 mb-4">
                <button
                  ...
                  className={`flex-1 py-3 rounded-lg font-semibold transition ${
                    usePrompt
                      ? 'bg-yellow-800/50 text-yellow-300 border-2 border-yellow-400'
              ...
              {usePrompt ? (
                    ...
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-lg border-2 transition ${
                        selectedPrompt === prompt
                          ? 'border-yellow-400 bg-yellow-800/30'
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-yellow-400 focus:border-transparent outline-none transition resize-none"
