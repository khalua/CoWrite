    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800 rounded-2xl border border-gray-700 w-full max-w-md p-8 text-center">
          ...
          <Link
            to="/"
            className="inline-block px-6 py-3 bg-gradient-to-r from-yellow-400 to-amber-400 text-white font-semibold rounded-lg hover:opacity-90 transition"
          >
            Go to Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl border border-gray-700 w-full max-w-md p-8">
        <div className="w-16 h-16 bg-yellow-800/50 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="bg-yellow-800/30 border border-yellow-600/50 rounded-xl p-4 mb-6 text-center">
          <p className="text-xl font-bold text-yellow-300">{invitation.circle_name}</p>
        </div>
        ...
        {isAuthenticated ? (
          ...
          <div className="space-y-4">
            ...
            <Link
              ...
              className="block w-full py-3 border-2 border-yellow-400 text-yellow-300 font-semibold rounded-lg hover:bg-yellow-400/10 transition text-center"
            >
              Log In
            </Link>
          </div>
