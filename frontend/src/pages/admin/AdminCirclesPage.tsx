            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <div className="flex -space-x-2">
                {circle.members.slice(0, 5).map((member) => (
                  <div
                    key={member.id}
                    className="w-8 h-8 rounded-full bg-gradient-to-r from-yellow-300 to-amber-300 flex items-center justify-center text-black text-xs font-medium border-2 border-gray-800"
