    ...
    <div>
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
          ...
          <p className="text-3xl font-bold text-yellow-300">{stats.activeStories}</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/admin/users" className="text-sm text-yellow-300 hover:text-yellow-300">
              View all
            </Link>
          </div>
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/admin/stories" className="text-sm text-yellow-300 hover:text-yellow-300">
              View all
            </Link>
          </div>
          <div className="space-y-3">
